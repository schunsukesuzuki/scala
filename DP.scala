//https://github.com/pathikrit/scalgos/blob/master/src/main/scala/com/github/pathikrit/scalgos/DynamicProgramming.scala
...
object DynamicProgramming {
  ...
  def isSubsetSumAchievable(s: List[Int], t: Int) = {
    ...
    lazy val f: DP = Memo {
      // 0 can always be achieved using empty list
      case (_, 0) => true
